...
public final class ItemBookBinding implements ViewBinding {
  ...
  private ItemBookBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgCover,
      @NonNull TextView tvAuthor, @NonNull TextView tvBadge, @NonNull TextView tvTitle) {
  ...
  public static ItemBookBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBookBinding((LinearLayout) rootView, imgCover, tvAuthor, tvBadge, tvTitle);
    }
